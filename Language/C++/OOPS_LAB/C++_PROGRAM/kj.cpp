...
{ private:
  int a,c1,c2,c3,c4;
  char a_tp1[2][20],bd_tp1[2][20];
  public:
  room2()
  { strcpy(a_tp1[1],"AC"); strcpy(a_tp1[2],"NON_AC"); a=10; 
    strcpy(bd_tp1[1],"SINGLE_BED"); strcpy(bd_tp1[2],"DOUBLE_BED");
    c1=2000; c2=3000; c3=1000; c4=2000;  cout<<bd_tp1[1];
  }
  //int inp2();
};
class customer
...
{   int n;
    ...
    if(a>=1)
    { switch(n)
      { case 1: inp(c1,a_tp1[1]); --a; return(1);
                break;
        case 2: inp(c2,a_tp1[1]); --a; return(2);
                break;
        case 3: inp(c3,a_tp1[2]); --a; return(3);
                break;
        case 4: inp(c4,a_tp1[2]); --a; return(4);
                break;
        default: return(0);
      }   
    }
